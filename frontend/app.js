...
function initAgent() {
  ...
  function setState(s) {
    ...
    // WebM видео — все платформы включая iOS 16+ и Safari
  ...
  const HINTS = [
    ...
    'Поддерживающая уборка от 120 BYN 🧽',
    'Генеральная уборка от 350 BYN 🧹',
    'Уборка после ремонта от 350 BYN 🏗',
    'Химчистка дивана от 90 BYN 🛋',
    'Химчистка матраса от 50 BYN 😴',
    'Мойка окон от 15 BYN/створка 🪟',
    'Химчистка ковра 10 BYN/м² 🏠',
    'Без предоплаты 👍',
    'Работаем Пн–Вс 🗓',
